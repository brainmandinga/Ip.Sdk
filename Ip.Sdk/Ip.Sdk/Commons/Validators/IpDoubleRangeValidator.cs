...
{
    /// <summary>
    /// Validates a double against a range
    /// </summary>
    public class IpDoubleRangeValidator : IpRangeValidator<double>
    {
        /// <summary>
        ...
        public IpDoubleRangeValidator(double value, double rangeStart, bool rangeStartInclusive, double rangeEnd, bool rangeEndInclusive)
