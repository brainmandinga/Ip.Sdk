...
{
    /// <summary>
    /// Validates a decimal against a range
    /// </summary>
    public class IpDecimalRangeValidator : IpRangeValidator<decimal>
    {
        /// <summary>
        ...
        public IpDecimalRangeValidator(decimal value, decimal rangeStart, bool rangeStartInclusive, decimal rangeEnd, bool rangeEndInclusive)
