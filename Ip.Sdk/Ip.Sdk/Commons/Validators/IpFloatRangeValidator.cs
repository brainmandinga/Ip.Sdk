...
{
    /// <summary>
    /// Validates a float against a range
    /// </summary>
    public class IpFloatRangeValidator : IpRangeValidator<float>
    {
        /// <summary>
        ...
        public IpFloatRangeValidator(float value, float rangeStart, bool rangeStartInclusive, float rangeEnd, bool rangeEndInclusive)
