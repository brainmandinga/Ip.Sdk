...
{
    /// <summary>
    /// Validates a datetime against a range
    /// </summary>
    public class IpDateTimeRangeValidator : IpRangeValidator<DateTime>
    {
        /// <summary>
        ...
        public IpDateTimeRangeValidator(DateTime value, DateTime rangeStart, bool rangeStartInclusive, DateTime rangeEnd, bool rangeEndInclusive)
