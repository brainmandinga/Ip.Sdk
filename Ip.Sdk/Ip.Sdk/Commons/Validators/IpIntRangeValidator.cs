...
{
    /// <summary>
    /// Validates an int against a range
    /// </summary>
    public class IpIntRangeValidator : IpRangeValidator<int>
    {
        /// <summary>
        ...
        public IpIntRangeValidator(int value, int rangeStart, bool rangeStartInclusive, int rangeEnd, bool rangeEndInclusive)
